...
<head>
    ...
    <title>收藏夹-图灵社区</title>
    <meta name="apple-mobile-web-app-capable" content="yes">
    <meta name="format-detection" content="telephone=no">
    <link rel="shortcut icon" href="/staticitr/img/favicon.png">
    <meta itemprop="name" content="收藏夹" />
    <meta itemprop="image" />

    
    <link href="/W-IyudFsjvr8DmczNaEtVDAWVVWkoAYhOkQl_7kkbqc1.js" rel="stylesheet"/>
...
<div class="nav-tab-primary">
    ...
    <ul class="nav nav-tabs text-right">
        <li   class="active"  >
            <a href="/user/fav/337835?type=book">图书</a>
        </li>
        <li >
            <a href="/user/fav/337835?type=article">文章</a>
        </li>
    </ul>
</div>
...
<div class="g-main">
        <div class="block block-books block-books-grid">
            <ul class="block-items">
                <c:forEach var="book" items="${fBook}">
                    <li class="block-item">
                        <div class="book-img">
    <a href="/book/${book.bookId}" title="${book.bookTitle}">
        <img src="${book.imageLink}" alt="${book.bookTitle}">
    </a>
</div>
<div class="book-info">
    <h4 class="name"><a href="/book/${book.bookId}" title="${book.bookTitle}">${book.bookTitle}</a></h4>
    <div class="author">
            <span>
...
<c:forEach var="translatorAuthor" items="${book.translatorAuthors}">
    ...
    <p class="intro">${book.bookIntro}</p>
...
<script type="text/javascript">
    $(function () {
        if ('fav' === 'index' && 'user' !== 'user') {
            ...
            $("li.sidenav-minor")
                .filter(function (index) {
                    return $(this).find('a').attr('href').indexOf('fav') > 0;
                })
                .addClass("active");
        }
