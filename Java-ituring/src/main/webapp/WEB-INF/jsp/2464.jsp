...
<head>
    ...
    <script src="/ituring/js?v=20qhuba-JjWpkUZ6WyvMzCPWFrB_TrAdbOFot0ehZMw1"></script>
                ...
                <div class="block-body">
                    <ul class="publish-info">
                        ...
                        <li><strong>系列书名</strong>${book.publishInfo.seriesName}</li>
                                                ...
                                                <li><strong>出版日期</strong><fmt:formatDate pattern="yyyy-MM-dd" value="${book.publishInfo.bookDate}" /></li>
